...
window.addEventListener('DOMContentLoaded', function() {
	...
	if(userschoolrows == 1) {
		...
		userschool.innerHTML = "<input type=\"hidden\" name=\"eduIdx\" value=\"\">";
	...
	if(userQualifirows == 1) {
		...
		userQualifi.innerHTML = "<input type=\"hidden\" name=\"qualifiIdx\" value=\"\">";
	...
	if(userCareerrows == 2) {
		...
		userCareer.innerHTML = "<input type=\"hidden\" name=\"careerIdx\" value=\"\">";
	...
	if(userTrainingrows == 1) {
		...
		userTraining.innerHTML = "<input type=\"hidden\" name=\"trainingIdx\" value=\"\">";
	...
	if(userLicenrows == 1) {
		...
		userLicen.innerHTML = "<input type=\"hidden\" name=\"licenIdx\" value=\"\">";
	...
	if(userProjectrows == 2) {
		...
		userProject.innerHTML = "<input type=\"hidden\" name=\"skillProjectIdx\" value=\"\">";
...
function minBtn(idx) {
	if(idx == 1) {
		...
		let idx1 = document.getElementsByName("eduIdx");
		
		if(document.getElementById("dle1").value == null || document.getElementById("dle1").value == "") {
			document.getElementById("dle1").value = idx1[idx1.length-1].value;
		} else {
			document.getElementById("dle1").value = document.getElementById("dle1").value + "," +idx1[idx1.length-1].value;
		}
		
		/* alert("학교명 idx = "+idx12[idx12.length-1].value); */
		
		/* var deleteArr = new int[idx12.length]; */
	...
	if(idx == 2) {
		...
		let idx2 = document.getElementsByName("qualifiIdx");
		
		if(document.getElementById("dle2").value == null || document.getElementById("dle2").value == "") {
			document.getElementById("dle2").value = idx2[idx2.length-1].value;
		} else {
			document.getElementById("dle2").value = document.getElementById("dle2").value + "," +idx2[idx2.length-1].value;
		}
	...
	if(idx == 3) {
		...
		let idx3 = document.getElementsByName("careerIdx");
		
		if(document.getElementById("dle3").value == null || document.getElementById("dle3").value == "") {
			document.getElementById("dle3").value = idx3[idx3.length-1].value;
		} else {
			document.getElementById("dle3").value = document.getElementById("dle3").value + "," +idx3[idx3.length-1].value;
		}
	...
	if(idx == 4) {
		...
		let idx4 = document.getElementsByName("trainingIdx");
		
		if(document.getElementById("dle4").value == null || document.getElementById("dle4").value == "") {
			document.getElementById("dle4").value = idx4[idx4.length-1].value;
		} else {
			document.getElementById("dle4").value = document.getElementById("dle4").value + "," +idx4[idx4.length-1].value;
		}
	...
	if(idx == 5) {
		...
		let idx5 = document.getElementsByName("licenIdx");
		
		if(document.getElementById("dle5").value == null || document.getElementById("dle5").value == "") {
			document.getElementById("dle5").value = idx5[idx5.length-1].value;
		} else {
			document.getElementById("dle5").value = document.getElementById("dle5").value + "," +idx5[idx5.length-1].value;
		}
	...
	if(idx == 6) {
		...
		let idx6 = document.getElementsByName("skillProjectIdx");
		
		if(document.getElementById("dle6").value == null || document.getElementById("dle6").value == "") {
			document.getElementById("dle6").value = idx6[idx6.length-1].value;
		} else {
			document.getElementById("dle6").value = document.getElementById("dle6").value + "," +idx6[idx6.length-1].value;
		}
...
function check() {
	...
	let userSocialSecunum = document.getElementById("userSocialSecunum");
	
	const regUSS = /^[0-9]{13,13}$/;
	
	if(i.userName.value == "") {
		alert("이름이 입력되지 않았습니다.");
		return i.userName.focus();
	}
	
	if(i.userSocialSecunum.value == "") {
		alert("주민등록번호가 입력되지 않았습니다.");
		return i.userSocialSecunum.focus();
	} else if(!msg(regUSS,userSocialSecunum,"주민등록번호(13수)가 숫자로만 입력 가능합니다.")) {
		return false;
	}
...
function msg(re,cu,message) {
	if(re.test(cu.value)) {return true;}
	alert(message);
	cu.select();
	return false;
}
...
<body>
	...
	<h2>개 인 이 력 카 드</h2>
	<form action="/cardInsert" name="i" method="post">
	<div class="inputBox">
		<div class="leftbox">
			<p>
			<c:choose>
		...
		<div class="rightbox">
			...
			<input type="submit" value="저장" onclick="check(); return false;">
		...
		<table class="userinfo" border="1">
			<c:choose>
				...
				<tr>
					...
					<th>*주민등록번호</th>
					<td colspan="3">
						<input type="text" name="userSocialSecunum" id="userSocialSecunum" maxlength="13" placeholder='"-" 제외한 숫자만 입력'> 
					</td>
					<th>성별</th>
					<td>
				...
				<tr>
					...
					<th>*주민등록번호</th>
					<td colspan="3">
						<input type="text" name="userSocialSecunum" id="userSocialSecunum" maxlength="13" value="${userInfo.userSocialSecunum }" placeholder='"-" 제외한 숫자만 입력'> 
					</td>
					<th>성별</th>
					<td>
						<select name="userGender">
		...
		<div class="table3">
			...
			<c:choose>
				...
				<c:when test="${userInfoEdu != null }">
					...
					<c:forEach var="userInfoEdu" items="${userInfoEdu }">
						<tr>
							<td>
								<input type="hidden" name="eduIdx" value="${userInfoEdu.eduIdx }">
			...
			<div class="btnBox">
				...
				<div class="minBox">
					<input type="hidden" name="dle1" id="dle1" value="">
		...
		<div class="table4">
			...
			<c:choose>
				<c:when test="${userInfoQualifi == null }">
					...
					<tr>
						<td>
							<input type="hidden" name="qualifiIdx" value="">
				...
				<c:when test="${userInfoQualifi != null }">
					...
					<c:forEach var="userInfoQualifi" items="${userInfoQualifi }">
						<tr>
							<td>
								<input type="hidden" name="qualifiIdx" value="${userInfoQualifi.qualifiIdx }">
			...
			<div class="btnBox">
				...
				<div class="minBox">
					<input type="hidden" name="dle2" id="dle2" value="">
		...
		<table id="userCareer" border="1">
			...
			<c:choose>
				<c:when test="${userInfoCareer == null }">
					<tr>
						<td>
							<input type="hidden" name="careerIdx" value="">
				...
				<c:when test="${userInfoCareer != null }">
					<c:forEach var="userCareer" items="${userInfoCareer}">
						<tr>
							<td>
								<input type="hidden" name="careerIdx" value="${userCareer.careerIdx }">
		...
		<div class="btnBox">
			...
			<div class="minBox">
				<input type="hidden" name="dle3" id="dle3" value="">
		...
		<div class="table5">
			...
			<c:choose>
				<c:when test="${userInfoTraining == null}">
					...
					<tr>
						<td>
							<input type="hidden" name="trainingIdx" value="">
				...
				<c:when test="${userInfoTraining != null}">
					...
					<c:forEach var="userInfoTraining" items="${userInfoTraining }">
						<tr>
							<td>
								<input type="hidden" name="trainingIdx" value="${userInfoTraining.trainingIdx }">
			...
			<div class="btnBox">
				...
				<div class="minBox">
					<input type="hidden" name="dle4" id="dle4" value="">
		...
		<div class="table6">
			...
			<c:choose>
				<c:when test="${userInfoLicen == null }">
					...
					<tr>
						<td>
							<input type="hidden" name="licenIdx" value="">
				...
				<c:when test="${userInfoLicen != null }">
					...
					<c:forEach var="userInfoLicen" items="${userInfoLicen }">
						<tr>
							<td>
								<input type="hidden" name="licenIdx" value="${userInfoLicen.licenIdx }">
			...
			<div class="btnBox">
				...
				<div class="minBox">
					<input type="hidden" name="dle5" id="dle5" value="">
		...
		<c:choose>
			<c:when test="${userInfoProject == null }">
				...
				<tr>
					<td>
						<input type="hidden" name="skillProjectIdx" value="">
						<input type="text" name="skillProjectName">
					</td>
			...
			<c:when test="${userInfoProject != null }">
				...
				<c:forEach var="userInfoProject" items="${userInfoProject }">
					<tr>
						<td>
							<input type="hidden" name="skillProjectIdx" value="${userInfoProject.skillIdx }">
							<input type="text" name="skillProjectName" value="${userInfoProject.skillProjectName }">
						</td>
		...
		<div class="btnBox">
			...
			<div class="minBox">
				<input type="hidden" name="dle6" id="dle6" value="">
